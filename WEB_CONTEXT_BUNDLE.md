...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-936-erd-s-problem-936-6b2821cd-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-936"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-936-erd-s-problem-936-6b2821cd-v1",
      "problem_contract_sha256": "1858b6b93a24a8af6cc1840404897222e6b023f2d0121efd89ef4e42352231b8",
      "problem_id": "problem:um-ep-936-erd-s-problem-936-6b2821cd",
      "route_id": "route:um-ep-936-erd-s-problem-936-6b2821cd-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-936-erd-s-problem-936-6b2821cd-source-fidelity-01",
      "graph_id": "graph:um-ep-936-erd-s-problem-936-6b2821cd-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-936-erd-s-problem-936-6b2821cd-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-936-erd-s-problem-936-6b2821cd-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Are $ 2^n\\pm 1 $ and $ n!\\pm 1 $ powerful (i.e. if $p\\mid m$ then $p^2\\mid m$) for only finitely many $n$?"
          },
          "statement_sha256": "2140f62afc070da92e9c9624bd7965314100efe04d29c5b9d5760bbe53e18e2e"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-936-erd-s-problem-936-6b2821cd-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-936-erd-s-problem-936-6b2821cd-root",
      "route_id": "route:um-ep-936-erd-s-problem-936-6b2821cd-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-936-6133f947f9d3",
        "url": "https://www.unsolvedmath.com/problems/EP-936"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
